  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsxs(Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxs(Field.Root, { children: [
        ...
        /* @__PURE__ */ jsx(Field.Input, { name: "token", type: "password", value: data.mercadoPagoToken, endAction: /* @__PURE__ */ jsx(Eye, {}) })
      ] })
    ] })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-DaAJyn4H.mjs");
        return App;
      }
    });
...
//# sourceMappingURL=index-DKL83Osi.mjs.map
