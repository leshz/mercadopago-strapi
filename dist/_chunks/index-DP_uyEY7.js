...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-CNts6yqN.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const Configuration = await Promise.resolve().then(() => require("./App-CNts6yqN.js"));
...
exports.index = index;
//# sourceMappingURL=index-DP_uyEY7.js.map
