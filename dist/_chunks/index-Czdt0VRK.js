  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SingleSelect, { value: data.defaultCurrency, onChange: (ev) => {
          setData2({ ...data, defaultCurrency: ev.target.value });
        }, children: [
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-DhBVmRVx.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-Czdt0VRK.js.map
