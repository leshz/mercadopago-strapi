      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Field.Input,
          {
            ...
            endAction: showToken ? /* @__PURE__ */ jsxRuntime.jsx(icons.EyeStriked, { onClick: () => setShowToken(false) }) : /* @__PURE__ */ jsxRuntime.jsx(icons.Eye, { onClick: () => setShowToken(true) })
          }
        )
      ] })
    ] })
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BSqVmuYq.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CQ_09Lk9.js.map
