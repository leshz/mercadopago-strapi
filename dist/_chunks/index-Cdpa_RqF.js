...
function baseMergeDeep$1(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    ...
    if (isArr || isBuff || isTyped) {
      ...
      } else if (!isObject$9(objValue) || isFunction$3(objValue)) {
...
var Stack$3 = _Stack, assignMergeValue = _assignMergeValue, baseFor = _baseFor, baseMergeDeep = _baseMergeDeep, isObject$8 = isObject_1, keysIn$3 = keysIn_1, safeGet = _safeGet;
...
var baseSetToString$1 = !defineProperty ? identity$3 : function(func2, string) {
...
function isIterateeCall$1(value, index, object) {
  ...
  if (type2 == "number" ? isArrayLike$1(object) && isIndex$3(index, object.length) : type2 == "string" && index in object) {
...
function arrayMap$3(array, iteratee2) {
...
var isArray$c = isArray_1, isKey$2 = _isKey, stringToPath$2 = _stringToPath, toString$2 = toString_1;
...
function basePickBy$1(object, paths, predicate) {
  ...
  while (++index < length) {
    var path = paths[index], value = baseGet$3(object, path);
...
function hasPath$1(object, path, hasFunc) {
  ...
  return !!length && isLength(length) && isIndex$1(key, length) && (isArray$b(object) || isArguments$1(object));
}
...
var rearg_1 = rearg;
var arrayMap$1 = _arrayMap, copyArray = _copyArray, isArray$5 = isArray_1, isSymbol$1 = isSymbol_1, stringToPath$1 = _stringToPath, toKey$1 = _toKey, toString$1 = toString_1;
function toPath(value) {
  if (isArray$5(value)) {
    return arrayMap$1(value, toKey$1);
  }
  return isSymbol$1(value) ? [value] : copyArray(stringToPath$1(toString$1(value)));
}
var toPath_1 = toPath;
var _util = {
  "ary": ary_1,
...
var merge$1 = function merge(target, source, options) {
  ...
  if (typeof source !== "object" && typeof source !== "function") {
    if (isArray$3(target)) {
      ...
      if (options && typeof options.arrayLimit === "number" && nextIndex > options.arrayLimit) {
        return markOverflow(arrayToObject$1(target.concat(source), options), nextIndex);
      }
  ...
  if (!target || typeof target !== "object") {
    ...
    if (options && typeof options.arrayLimit === "number" && combined.length > options.arrayLimit) {
      return markOverflow(arrayToObject$1(combined, options), combined.length - 1);
    }
    return combined;
  }
...
var parseValues = function parseQueryStringValues(str, options) {
  ...
  for (i2 = 0; i2 < parts.length; ++i2) {
    ...
    if (options.comma && isArray$1(val) && val.length > options.arrayLimit) {
      ...
      val = utils$2.combine([], val, options.arrayLimit, options.plainObjects);
    }
    if (key !== null) {
  ...
  for (var i2 = chain.length - 1; i2 >= 0; --i2) {
    ...
    if (root2 === "[]" && options.parseArrays) {
      ...
      if (!options.parseArrays && decodedRoot === "") {
        ...
        obj[index] = leaf;
        utils$2.markOverflow(obj, index);
...
const isEmptyObject = (val) => {
  if (!isObject$1(val) || isBuffer2(val)) {
    return false;
  }
  try {
...
var baseMerge$1 = _baseMerge, isObject = isObject_1;
...
const getDashboardStats = async (fetchClient, days = 30) => {
...
//# sourceMappingURL=index-Cdpa_RqF.js.map
