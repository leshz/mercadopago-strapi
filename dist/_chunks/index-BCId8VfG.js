  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: "MercadopagoToken" }),
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-DhVz-Feb.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-BCId8VfG.js.map
