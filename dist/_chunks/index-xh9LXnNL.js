...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-HD-5piSw.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-Ca21_gEx.js"));
          return SettingsPage;
        }
      }
    ]);
...
exports.index = index;
//# sourceMappingURL=index-xh9LXnNL.js.map
