      ...
      /* @__PURE__ */ jsxs(Field.Root, { children: [
        ...
        /* @__PURE__ */ jsx(
          Field.Input,
          {
            ...
            endAction: showToken ? /* @__PURE__ */ jsx(EyeStriked, { onClick: () => setShowToken(false) }) : /* @__PURE__ */ jsx(Eye, { onClick: () => setShowToken(true) })
          }
        )
      ] })
    ] })
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-CrWJV1Qv.mjs");
        return App;
      }
    });
...
//# sourceMappingURL=index-DFuS27bn.mjs.map
