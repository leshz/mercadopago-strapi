...
import { Link, Alert, Typography, Box, Flex, useCallbackRef, useComposedRefs, Field, Toggle, Checkbox, DatePicker, DateTimePicker, TextInput, SingleSelect, SingleSelectOption, JSONInput, NumberInput, Textarea, TimePicker, Popover, Button, useField as useField$1, Main } from "@strapi/design-system";
  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsxs(Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxs(Field.Root, { children: [
        ...
        /* @__PURE__ */ jsx(Field.Input, { name: "token", type: "password", endAction: /* @__PURE__ */ jsx(Eye, {}) })
      ] })
    ] })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-tsNjf1bt.mjs");
        return App;
      }
    });
...
//# sourceMappingURL=index-D9Bx5171.mjs.map
