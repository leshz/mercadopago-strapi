...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-eWvn2MIM.js"));
        return App;
      }
    });
      ...
      [
        {
          ...
          Component: async () => {
            const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-CbSYV-Fs.js"));
            return SettingsPage;
          }
        }
      ]
...
exports.index = index;
//# sourceMappingURL=index-lVwVgdyK.js.map
