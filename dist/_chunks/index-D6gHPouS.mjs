...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-CYgUILuC.mjs");
        return App;
      }
    });
    app.registerPlugin({
...
//# sourceMappingURL=index-D6gHPouS.mjs.map
