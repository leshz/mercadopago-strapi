...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-DmfdURlV.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-CbrxD1o_.js"));
          return SettingsPage;
        }
      }
    ]);
...
exports.index = index;
//# sourceMappingURL=index-D2b0Vw0L.js.map
