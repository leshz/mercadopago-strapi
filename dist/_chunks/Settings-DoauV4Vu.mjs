...
import { Link, Alert, Typography, Box, Flex, useCallbackRef, useComposedRefs, Field, Toggle, Checkbox, DatePicker, DateTimePicker, TextInput, SingleSelect, SingleSelectOption, JSONInput, NumberInput, Textarea, TimePicker, Popover, Button, DesignSystemProvider, darkTheme, Main, ToggleInput } from "@strapi/design-system";
import "react-dom/client";
import { useLocation, useNavigate, NavLink } from "react-router-dom";
import * as React from "react";
import React__default, { useContext, useRef, useCallback, useDebugValue, useMemo, useState, useEffect, useLayoutEffect, createContext as createContext$1, createElement, useReducer, forwardRef, memo } from "react";
...
import { g as getTranslation } from "./getTranslation-ChTK819y.mjs";
...
const SettingsPage = () => {
  const { formatMessage } = useIntl();
  return /* @__PURE__ */ jsx(DesignSystemProvider, { theme: darkTheme, children: /* @__PURE__ */ jsx(Box, { background: "neutral100", children: /* @__PURE__ */ jsxs(Main, { children: [
    /* @__PURE__ */ jsx(
      Layouts.Header,
      {
    ...
    /* @__PURE__ */ jsx(Box, { padding: 8, children: /* @__PURE__ */ jsx(Flex, { gap: {
      initial: 1,
      medium: 4,
      large: 8
    }, direction: {
      ...
      initial: "center",
      medium: "flex-start"
    }, children: /* @__PURE__ */ jsx(ToggleInput, { label: "Enabled", onLabel: "True", offLabel: "False", hint: "Enable your SSO provider for users" }) }) })
  ] }) }) });
};
export {
  SettingsPage
};
//# sourceMappingURL=Settings-DoauV4Vu.mjs.map
