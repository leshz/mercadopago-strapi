...
import { P as PLUGIN_ID } from "./index-UmRaAmtE.mjs";
...
const getConfigRequest = async () => {
  const response = await axios.get("/strapi-mercadopago/configuration");
  console.log(response.data, "requesst");
...
//# sourceMappingURL=App-Cbhp6VEo.mjs.map
