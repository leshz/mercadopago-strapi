...
import { P as PLUGIN_ID } from "./index-DRR_ztH2.mjs";
...
const HomePage = () => {
  ...
  console.log(data);
  return /* @__PURE__ */ jsx(Main, { children: /* @__PURE__ */ jsx(Layout, { children: /* @__PURE__ */ jsxs("h1", { children: [
    "Welcome to ",
...
//# sourceMappingURL=App-X4zVZDVm.mjs.map
