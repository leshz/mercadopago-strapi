...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-WzgyomdS.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const Configuration = await Promise.resolve().then(() => require("./App-WzgyomdS.js"));
...
exports.index = index;
//# sourceMappingURL=index-WjeLhgqv.js.map
