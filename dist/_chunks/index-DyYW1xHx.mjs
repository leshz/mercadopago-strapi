  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsxs(Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxs(Field.Root, { children: [
        /* @__PURE__ */ jsx(Field.Label, { children: "MercadopagoToken" }),
        /* @__PURE__ */ jsx(Field.Input, { type: "password", placeholder: "Ted Lasso", endAction: /* @__PURE__ */ jsx(Eye, {}) })
      ] })
    ] })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-CXgD8RK8.mjs");
        return App;
      }
    });
...
//# sourceMappingURL=index-DyYW1xHx.mjs.map
