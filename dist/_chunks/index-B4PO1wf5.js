  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Input, { type: "password", placeholder: "Ted Lasso", endAction: /* @__PURE__ */ jsxRuntime.jsx(icons.Eye, {}) })
      ] })
    ] })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-Cvh5RLjI.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-B4PO1wf5.js.map
