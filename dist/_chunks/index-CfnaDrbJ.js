...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: {
      ...
      initial: "center",
      medium: "flex-start"
    }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Toggle, { checked: data.isActive, onChange: () => {
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-CkNSsBL-.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CfnaDrbJ.js.map
