...
React.forwardRef(
  ({ disabled = false, method, onSubmit, initialErrors, ...props }, ref2) => {
    ...
    const setSubmitting = React.useCallback((isSubmitting2) => {
      dispatch({ type: "SET_ISSUBMITTING", payload: isSubmitting2 });
    }, []);
    const composedRefs = useComposedRefs(formRef, ref2);
    return /* @__PURE__ */ jsx("form", { ref: composedRefs, method, noValidate: true, onSubmit: handleSubmit2, children: /* @__PURE__ */ jsx(
      FormProvider,
      {
        disabled,
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsx(ContentBox, { title: "Configuración de Mercado Pago", description: "Configuración de la integración con Mercado Pago", children: /* @__PURE__ */ jsx(Box, { padding: 8, children: /* @__PURE__ */ jsx(Flex, { gap: {
      initial: 1,
      medium: 2,
      large: 2
    }, direction: {
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-BdemfSlt.mjs");
        return App;
      }
    });
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-BtZCt0I7.mjs"), "./translations/es.json": () => import("./es-DSaSUfOy.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
...
//# sourceMappingURL=index-D668hCge.mjs.map
