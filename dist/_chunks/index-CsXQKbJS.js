...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BJ9uMUAw.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
      ...
      intlLabel: {
        ...
        defaultMessage: "Mercadopago configuracion"
      }
    }, [
      {
        id: `${settingsBaseName}.links-header`,
        ...
        Component: async () => {
          const Configuration = await Promise.resolve().then(() => require("./App-BJ9uMUAw.js"));
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-B4KWt_jN.js")), "./translations/es.json": () => Promise.resolve().then(() => require("./es-Cb6O-nM6.js")) }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
...
exports.index = index;
//# sourceMappingURL=index-CsXQKbJS.js.map
