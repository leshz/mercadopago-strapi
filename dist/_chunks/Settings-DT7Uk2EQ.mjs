...
const SettingsPage = () => {
  ...
  useIntl();
  console.log(data);
  return /* @__PURE__ */ jsx(DesignSystemProvider, { theme: darkTheme, children: /* @__PURE__ */ jsx(Box, { background: "neutral100", children: /* @__PURE__ */ jsx(Layouts.BaseHeader, { children: /* @__PURE__ */ jsx(Main, { children: /* @__PURE__ */ jsxs(Flex, { gap: {
    initial: 1,
    medium: 4,
    large: 8
  }, direction: {
...
//# sourceMappingURL=Settings-DT7Uk2EQ.mjs.map
