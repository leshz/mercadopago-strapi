...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BX0QTT5v.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-DMNHPiEI.js"));
          return SettingsPage;
        }
      }
    ]);
...
exports.index = index;
//# sourceMappingURL=index-CIi16x9d.js.map
