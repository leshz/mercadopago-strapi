...
import { P as PLUGIN_ID } from "./index-qaWL2HDQ.mjs";
...
const HomePage = () => {
  ...
  console.log(data);
  return /* @__PURE__ */ jsx(Main, { children: /* @__PURE__ */ jsx(ContentLayout, { children: /* @__PURE__ */ jsxs("h1", { children: [
    "Welcome to ",
...
//# sourceMappingURL=App-C8PWa71E.mjs.map
