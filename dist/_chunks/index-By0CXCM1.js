...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-Bbn1bc_J.js"));
        return App;
      }
    });
    app.registerPlugin({
...
exports.index = index;
//# sourceMappingURL=index-By0CXCM1.js.map
