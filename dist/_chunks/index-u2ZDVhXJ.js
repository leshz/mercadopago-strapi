...
const MeliLogo = () => /* @__PURE__ */ jsxRuntime.jsxs(
  "svg",
  {
    id: "logos",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-DpDCQgdB.js"));
        return App;
      }
    });
    app.registerPlugin({
...
exports.index = index;
//# sourceMappingURL=index-u2ZDVhXJ.js.map
