...
import { Link, Alert, Typography, Box, Flex, useCallbackRef, useComposedRefs, Field, Toggle, Checkbox, DatePicker, DateTimePicker, TextInput, SingleSelect, SingleSelectOption, JSONInput, NumberInput, Textarea, TimePicker, Popover, Button, DesignSystemProvider, darkTheme, Main } from "@strapi/design-system";
...
import { g as getTranslation } from "./getTranslation-BZPwdYDh.mjs";
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsx(DesignSystemProvider, { theme: darkTheme, children: /* @__PURE__ */ jsx(Box, { background: "neutral100", children: /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsx(Box, { padding: 8, children: /* @__PURE__ */ jsx(Flex, { gap: {
      ...
      initial: "center",
      medium: "flex-start"
    }, children: /* @__PURE__ */ jsx(Toggle, { label: "Enabled", onLabel: "True", offLabel: "False", hint: "Enable your SSO provider for users" }) }) })
  ] }) }) });
};
export {
  SettingsPage
};
//# sourceMappingURL=Settings-CciuIDNH.mjs.map
