...
import Check, { ArrowLeft, Eye, EyeStriked, WarningCircle, Filter, CaretDown } from "@strapi/icons";
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-wl0grJ_w.mjs");
        return App;
      }
    });
...
//# sourceMappingURL=index-B2XLa8sQ.mjs.map
