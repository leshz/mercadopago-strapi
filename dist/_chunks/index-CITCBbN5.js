...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BS6xnSG5.js"));
        return App;
      }
    });
    app.registerPlugin({
  ...
  boostrap(app) {
    app.addSettingsLink("mercadopago-settings", {
      intlLabel: { id: "Mercado pago config", defaultMessage: "Mercado pago config" },
      id: String,
      to: String,
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BS6xnSG5.js"));
...
exports.index = index;
//# sourceMappingURL=index-CITCBbN5.js.map
