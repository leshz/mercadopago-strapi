...
HeaderLayout$1.displayName = "HeaderLayout";
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsx(DesignSystemProvider, { theme: darkTheme, children: /* @__PURE__ */ jsx(Box, { background: "neutral100", children: /* @__PURE__ */ jsxs(Main, { children: [
    /* @__PURE__ */ jsx(Layouts.Header, { title: "Settings", subtitle: "Settings page" }),
...
//# sourceMappingURL=Settings-Df0bonaR.mjs.map
