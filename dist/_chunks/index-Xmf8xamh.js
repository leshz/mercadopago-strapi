...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-DPmt1O-e.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-BXlCwBIm.js"));
          return SettingsPage;
        }
      }
    ]);
...
exports.index = index;
//# sourceMappingURL=index-Xmf8xamh.js.map
