...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-B5fw0_gC.mjs");
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const { SettingsPage } = await import("./Settings-C7kE-eSf.mjs");
          return SettingsPage;
        }
      }
    ]);
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-B80bpMqV.mjs"), "./translations/es.json": () => import("./es-D3a-b-ck.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
...
//# sourceMappingURL=index-D3OvsmFe.mjs.map
