  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Input, { name: "token", type: "password", value: data.mercadoPagoToken, endAction: /* @__PURE__ */ jsxRuntime.jsx(icons.Eye, {}) })
      ] })
    ] })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-CrNLamRt.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-BnBQNiDL.js.map
