...
const getTranslation = require("./getTranslation-BGdn863s.js");
...
const SettingsPage = () => {
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.DesignSystemProvider, { theme: designSystem.darkTheme, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral100", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      Layouts.Header,
      {
        title: formatMessage({ id: getTranslation.getTranslation("setting.header.title") }),
        subtitle: formatMessage({ id: getTranslation.getTranslation("setting.header.subtitle") })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: {
      initial: 1,
      medium: 4,
      large: 8
    }, direction: {
      ...
      initial: "center",
      medium: "flex-start"
    }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.ToggleInput, { label: "Enabled", onLabel: "True", offLabel: "False", hint: "Enable your SSO provider for users" }) }) })
  ] }) }) });
};
exports.SettingsPage = SettingsPage;
//# sourceMappingURL=Settings-CqUVFpCv.js.map
