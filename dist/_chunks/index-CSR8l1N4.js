  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SingleSelect, { children: [
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-x0tGMC1c.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CSR8l1N4.js.map
