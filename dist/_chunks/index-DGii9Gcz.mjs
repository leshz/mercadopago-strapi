...
const MeliLogo = () => /* @__PURE__ */ jsxs(
  "svg",
  {
    ...
    children: [
      /* @__PURE__ */ jsx("title", { id: "logosTitle", children: "SVG Logos" }),
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-CzgZqEhk.mjs");
        return App;
      }
    });
    app.registerPlugin({
...
//# sourceMappingURL=index-DGii9Gcz.mjs.map
