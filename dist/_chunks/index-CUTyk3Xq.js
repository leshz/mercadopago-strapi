...
React__namespace.forwardRef(
  ({ disabled = false, method, onSubmit, initialErrors, ...props }, ref2) => {
    ...
    const setSubmitting = React__namespace.useCallback((isSubmitting2) => {
      dispatch({ type: "SET_ISSUBMITTING", payload: isSubmitting2 });
    }, []);
    const composedRefs = designSystem.useComposedRefs(formRef, ref2);
    return /* @__PURE__ */ jsxRuntime.jsx("form", { ref: composedRefs, method, noValidate: true, onSubmit: handleSubmit2, children: /* @__PURE__ */ jsxRuntime.jsx(
      FormProvider,
      {
        disabled,
      ...
      Layouts.Header,
      {
        ...
        primaryAction: /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Button,
          {
            ...
            startIcon: /* @__PURE__ */ jsxRuntime.jsx(Check, {}),
            size: "L",
            children: "Save"
          }
        )
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-C_uOIV5p.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CUTyk3Xq.js.map
