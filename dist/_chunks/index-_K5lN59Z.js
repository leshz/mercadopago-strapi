...
const SettingsPage = () => {
  ...
  const pepe = designSystem.useField("token");
  console.log(pepe);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 8, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Input, { name: "token", type: "password", endAction: /* @__PURE__ */ jsxRuntime.jsx(icons.Eye, {}) })
      ] })
    ] })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BbElHMPL.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-_K5lN59Z.js.map
