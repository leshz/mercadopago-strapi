...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: {
      ...
      initial: "center",
      medium: "flex-start"
    }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Toggle, { checked: data.isActive || true, onChange: () => {
    } }) }) })
  ] });
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BC1x_4Z2.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CiC70bcH.js.map
