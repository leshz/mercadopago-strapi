...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-CNBoUSk0.js"));
        return App;
      }
    });
    ...
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: async () => {
          const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-BRKXcvOF.js"));
          return SettingsPage;
        }
      }
    ]);
...
exports.index = index;
//# sourceMappingURL=index-0gTGs9Nl.js.map
