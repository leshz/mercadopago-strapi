...
const Check = require("@strapi/icons");
...
const Check__default = /* @__PURE__ */ _interopDefault(Check);
  ...
  ({ disabled, fallback = "" }, ref2) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Link,
      {
        ...
        startIcon: /* @__PURE__ */ jsxRuntime.jsx(Check.ArrowLeft, {}),
        ...
        designSystem.TextInput,
        {
          ...
          endAction: /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.Field.Action,
            {
              ...
              children: showPassword ? /* @__PURE__ */ jsxRuntime.jsx(Check.Eye, { fill: "neutral500" }) : /* @__PURE__ */ jsxRuntime.jsx(Check.EyeStriked, { fill: "neutral500" })
            }
          ),
          onChange: field.onChange,
          value: field.value,
...
styledComponents.styled(Check.WarningCircle)`
  width: 24px;
  height: 24px;
  ...
  ({ label }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover.Trigger, { children: /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Button,
      {
        variant: "tertiary",
        ref: forwardedRef,
        startIcon: /* @__PURE__ */ jsxRuntime.jsx(Check.Filter, {}),
        size: "S",
        disabled,
...
createContext("Table");
styledComponents.styled(Check.CaretDown)`
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      Layouts.Header,
      {
        ...
        primaryAction: /* @__PURE__ */ jsxRuntime.jsx(
          ...
          {
            type: "submit",
            startIcon: /* @__PURE__ */ jsxRuntime.jsx(Check__default.default, {}),
            size: "L",
            children: "Save"
          }
        )
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ContentBox, { title: "Configuración de Mercado Pago", description: "Configuración de la integración con Mercado Pago", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: {
      initial: 1,
      medium: 2,
      large: 2
    }, direction: {
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-Cx9L5GYc.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-nyOxrFzR.js.map
