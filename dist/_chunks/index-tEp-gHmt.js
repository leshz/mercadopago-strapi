...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-U4J8HoBt.js"));
        return App;
      }
    });
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-D2tGHDSo.js")), "./translations/es.json": () => Promise.resolve().then(() => require("./es-B5iZp259.js")) }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
...
exports.index = index;
//# sourceMappingURL=index-tEp-gHmt.js.map
