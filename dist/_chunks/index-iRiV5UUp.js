...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(icons.Alien, {});
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BracSBuh.js"));
        return App;
      }
    });
    app.registerPlugin({
...
exports.index = index;
//# sourceMappingURL=index-iRiV5UUp.js.map
