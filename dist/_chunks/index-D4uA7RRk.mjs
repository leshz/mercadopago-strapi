      ...
      /* @__PURE__ */ jsxs(Field.Root, { children: [
        ...
        /* @__PURE__ */ jsx(
          Field.Input,
          {
            ...
            endAction: showToken ? /* @__PURE__ */ jsx(Eye, { onClick: () => setShowToken(true) }) : /* @__PURE__ */ jsx(EyeStriked, { onClick: () => setShowToken(false) })
          }
        )
      ] })
    ] })
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-BubcOKOJ.mjs");
        return App;
      }
    });
...
//# sourceMappingURL=index-D4uA7RRk.mjs.map
