...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-CaSuhpvf.js"));
        return App;
      }
    });
      ...
      [
        {
          ...
          Component: async () => {
            const { SettingsPage } = await Promise.resolve().then(() => require("./Settings-CQDoiXoI.js"));
            return SettingsPage;
          }
        }
      ]
...
exports.index = index;
//# sourceMappingURL=index-C-ZpclRf.js.map
