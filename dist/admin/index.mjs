...
import { Link, Alert, Typography, Box, Flex, useCallbackRef, useComposedRefs, Field, Toggle, Checkbox, DatePicker, DateTimePicker, TextInput, SingleSelect, SingleSelectOption, JSONInput, NumberInput, Textarea, TimePicker, Popover, Button, Main, Divider } from "@strapi/design-system";
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ jsxs(Main, { children: [
    ...
    /* @__PURE__ */ jsx(Layouts.Root, { children: /* @__PURE__ */ jsxs(Box, { padding: 8, margin: 8, background: "neutral0", shadow: "filterShadow", hasRadius: true, children: [
      /* @__PURE__ */ jsxs(
        Flex,
        {
          gap: {
          ...
          children: [
            /* @__PURE__ */ jsxs(Field.Root, { children: [
              /* @__PURE__ */ jsx(Field.Label, { children: "Mercadopago active " }),
              /* @__PURE__ */ jsx(
                Toggle,
                {
                  onLabel: "Encendido",
      ...
      /* @__PURE__ */ jsxs(
        Flex,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs(Field.Root, { children: [
              /* @__PURE__ */ jsx(Field.Label, { children: "Verificacion Firma " }),
              /* @__PURE__ */ jsx(
                Toggle,
                {
                  onLabel: "Encendido",
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("../_chunks/en-CVBUb9hD.mjs"), "./translations/es.json": () => import("../_chunks/es-CHtAdAgu.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
