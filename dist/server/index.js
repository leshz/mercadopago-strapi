...
const product$2 = strapi$1.factories.createCoreController(
...
const configuration$2 = strapi$1.factories.createCoreController("plugin::strapi-mercadopago.configuration");
const controllers = {
  category: category$2,
  product: product$2,
  order: order$1,
  ...
  return async (ctx, next) => {
    try {
      ...
      if (ts && hash && dataID && xRequestId) {
        ...
        const hmac = require$$1__default.default.createHmac("sha256", secret);
...
const configuration = strapi$1.factories.createCoreService("plugin::strapi-mercadopago.configuration");
const services = {
  category,
  product,
  order,
